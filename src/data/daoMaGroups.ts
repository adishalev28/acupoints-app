...
export const daoMaClinicalGroups: DaoMaClinicalGroup[] = [
  ...
  },
  {
    ...
    clinicalFocus: ['סטגנציית צ\'י', 'סכיאטיקה', 'כאב גב תחתון', 'ריאות'],
    rootIndications: [
      'דיכוי צ\'י וסטגנציה (שורש: ריאות)',
      'סכיאטיקה על רקע חולשת ריאות',
    ],
    branchIndications: [
      'סכיאטיקה',
      'כאב גב תחתון',
    ...
    keyNotes: 'השילוב הנפוץ ביותר באקופונקטורה של מאסטר דונג. סכיאטיקה על רקע ריאות (בניגוד ל-22.06 Zhong Bai לסכיאטיקה על רקע כליות). זווית הדיקור משנה את ההתוויה!',
    bookReference: 'עמ\' 3-4, סכיאטיקה: שני סוגים',
  },
