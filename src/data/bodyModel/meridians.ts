...
export const bladderMeridian: MeridianDef = {
  id: 'bladder',
  hebrewName: 'ערוץ שלפוחית השתן',
  chineseName: '足太陽膀胱經',
  color: '#7aa7ff',
  explanation: [
    'ערוץ שלפוחית השתן הוא הארוך ביותר בגוף. הוא מתחיל בזווית הפנימית של העין, עובר מעל הראש, יורד בשני קווים מקבילים לאורך הגב משני צידי עמוד השדרה, וממשיך בגב הרגל עד קצה הזרת של כף הרגל.',
    'לאורך הגב יש עליו נקודה מול כל איבר - הריאות, הלב, הכבד, הטחול והכליות - ולכן דרכו אפשר להשפיע על האיברים הפנימיים.',
    'בגלל שהוא עובר בגב ובגב הרגל, משתמשים בנקודות שלו לכאבי גב, לסיאטיקה ולמתח בשרירי הגב.',
  ],
  controlPoints: [
    { id: 'BL1', pinyin: 'Jingming', hint: 'בזווית הפנימית של העין, מעט מעליה' },
    { id: 'BL2', pinyin: 'Zanzhu', hint: 'בקצה הפנימי של הגבה' },
    { id: 'BL7', pinyin: 'Tongtian', hint: 'בראש, 1.5 צון מהקו האמצעי, 4 צון מאחורי קו השיער' },
    { id: 'BL9', pinyin: 'Yuzhen', hint: 'בעורף, 1.3 צון מהקו האמצעי, בגובה הבליטה של העורף' },
    { id: 'BL10', pinyin: 'Tianzhu', hint: 'בעורף, בקו השיער, בצד החיצוני של השריר העבה שלאורך הצוואר' },
    { id: 'BL11', pinyin: 'Dazhu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה הראשונה של הגב' },
    { id: 'BL13', pinyin: 'Feishu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה השלישית - נקודת הריאות' },
    { id: 'BL15', pinyin: 'Xinshu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה החמישית - נקודת הלב' },
    { id: 'BL17', pinyin: 'Geshu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה השביעית, בערך בקו הקצה התחתון של השכמה' },
    { id: 'BL18', pinyin: 'Ganshu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה התשיעית - נקודת הכבד' },
    { id: 'BL20', pinyin: 'Pishu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה האחת עשרה - נקודת הטחול' },
    { id: 'BL23', pinyin: 'Shenshu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה המותנית השנייה - נקודת הכליות' },
    { id: 'BL25', pinyin: 'Dachangshu', hint: '1.5 צון מהקו האמצעי, בגובה החוליה המותנית הרביעית, בקו עצמות האגן' },
    { id: 'BL28', pinyin: 'Pangguangshu', hint: '1.5 צון מהקו האמצעי, בגובה החור השני של עצם העצה' },
    { id: 'BL36', pinyin: 'Chengfu', hint: 'באמצע קפל העכוז' },
    { id: 'BL37', pinyin: 'Yinmen', hint: 'בגב הירך, 6 צון מתחת לקפל העכוז' },
    { id: 'BL40', pinyin: 'Weizhong', hint: 'באמצע קפל הברך מאחור' },
    { id: 'BL41', pinyin: 'Fufen', hint: '3 צון מהקו האמצעי, בגובה החוליה השנייה של הגב' },
    { id: 'BL43', pinyin: 'Gaohuang', hint: '3 צון מהקו האמצעי, בגובה החוליה הרביעית, בשפה הפנימית של השכמה' },
    { id: 'BL47', pinyin: 'Hunmen', hint: '3 צון מהקו האמצעי, בגובה החוליה התשיעית' },
    { id: 'BL52', pinyin: 'Zhishi', hint: '3 צון מהקו האמצעי, בגובה החוליה המותנית השנייה' },
    { id: 'BL54', pinyin: 'Zhibian', hint: '3 צון מהקו האמצעי, בגובה הקצה התחתון של עצם העצה' },
    { id: 'BL39', pinyin: 'Weiyang', hint: 'בקצה החיצוני של קפל הברך מאחור' },
    { id: 'BL57', pinyin: 'Chengshan', hint: 'באמצע השוק מאחור, בשקע שמתחת לשריר התאומים' },
    { id: 'BL58', pinyin: 'Feiyang', hint: '7 צון מעל BL60, צון אחד החוצה מ-BL57' },
    { id: 'BL60', pinyin: 'Kunlun', hint: 'בשקע שבין הקרסול החיצוני לגיד אכילס' },
    { id: 'BL62', pinyin: 'Shenmai', hint: 'בשקע שמתחת לקרסול החיצוני' },
    { id: 'BL64', pinyin: 'Jinggu', hint: 'בצד החיצוני של כף הרגל, מתחת לבליטה של עצם המסרק החמישית' },
    { id: 'BL65', pinyin: 'Shugu', hint: 'בצד החיצוני של כף הרגל, מאחורי מפרק הבסיס של הזרת' },
    { id: 'BL67', pinyin: 'Zhiyin', hint: 'בפינה החיצונית של ציפורן הזרת של כף הרגל' },
  ],
  segments: [
    ['BL1', 'BL2', 'BL7', 'BL9', 'BL10', 'BL11', 'BL13', 'BL15', 'BL17', 'BL18', 'BL20', 'BL23', 'BL25', 'BL28', 'BL36', 'BL37', 'BL40', 'BL57', 'BL58', 'BL60', 'BL62', 'BL64', 'BL65', 'BL67'],
    // הענף החיצוני בגב מתאחד עם הראשי בקפל הברך
    ['BL10', 'BL41', 'BL43', 'BL47', 'BL52', 'BL54', 'BL39', 'BL40'],
  ],
}

export const kidneyMeridian: MeridianDef = {
  id: 'kidney',
  hebrewName: 'ערוץ הכליות',
  chineseName: '足少陰腎經',
  color: '#4fd1c5',
  explanation: [
    'ערוץ הכליות מתחיל בכף הרגל, מקיף את הקרסול הפנימי, עולה לאורך הצד הפנימי של הרגל, וממשיך בבטן ובחזה, קרוב לקו האמצע, עד מתחת לעצם הבריח.',
    'ברפואה הסינית הכליות הן שורש האנרגיה של הגוף. הן קשורות לגב התחתון, לברכיים, לעצמות, לשמיעה ולכוח החיוני שעובר מדור לדור.',
    'לכן נקודה ליד הקרסול הפנימי משמשת לכאבי גב תחתון, לעייפות עמוקה ולבעיות שינה.',
  ],
  controlPoints: [
    { id: 'KI1', pinyin: 'Yongquan', hint: 'בכף הרגל, בשקע שנוצר כשמכווצים את האצבעות, בשליש הקדמי' },
    { id: 'KI2', pinyin: 'Rangu', hint: 'בצד הפנימי של כף הרגל, מתחת לבליטה של עצם הסירה' },
    { id: 'KI3', pinyin: 'Taixi', hint: 'בשקע שבין הקרסול הפנימי לגיד אכילס' },
    { id: 'KI6', pinyin: 'Zhaohai', hint: 'בשקע שמתחת לקרסול הפנימי' },
    { id: 'KI7', pinyin: 'Fuliu', hint: '2 צון מעל KI3, בשפה הקדמית של גיד אכילס' },
    { id: 'KI9', pinyin: 'Zhubin', hint: '5 צון מעל KI3, בצד הפנימי של השוק' },
    { id: 'KI10', pinyin: 'Yingu', hint: 'בקצה הפנימי של קפל הברך מאחור, בין שני הגידים' },
    { id: 'KI11', pinyin: 'Henggu', hint: 'בשפה העליונה של עצם הערווה, חצי צון מהקו האמצעי' },
    { id: 'KI16', pinyin: 'Huangshu', hint: 'חצי צון לצד הטבור' },
    { id: 'KI21', pinyin: 'Youmen', hint: '6 צון מעל הטבור, חצי צון מהקו האמצעי' },
    { id: 'KI22', pinyin: 'Bulang', hint: 'במרווח הבין צלעי החמישי, 2 צון מהקו האמצעי' },
    { id: 'KI25', pinyin: 'Shencang', hint: 'במרווח הבין צלעי השני, 2 צון מהקו האמצעי' },
    { id: 'KI27', pinyin: 'Shufu', hint: 'מתחת לעצם הבריח, 2 צון מהקו האמצעי' },
  ],
  segments: [['KI1', 'KI2', 'KI3', 'KI6', 'KI7', 'KI9', 'KI10', 'KI11', 'KI16', 'KI21', 'KI22', 'KI25', 'KI27']],
}
